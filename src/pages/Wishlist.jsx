...
export default function Wishlist() {
  ...
  const { data: wishlistItems = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return base44.entities.WishlistItem.filter(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center py-20">
            ...
            <p className="text-slate-600 mb-8">
              Добавьте товары, чтобы не потерять их
            </p>
            ...
            >
              <Card className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-4">
                  ...
                  >
                    <h3 className="font-semibold text-slate-900 hover:text-violet-600 transition-colors line-clamp-2 mb-2">
                      {item.product_name}
                    </h3>
                  </Link>
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      onClick={() =>
                        moveToCartMutation.mutate(/** @type {WishlistItem} */ (item))
                      }
                    >
